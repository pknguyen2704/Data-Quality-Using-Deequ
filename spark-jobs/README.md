...
## Version 2: 
Sử dụng Deequ và Anomaly Detection với XGBoost để đọc dữ liệu từ các bảng đích. Các job độc lập, các job sẽ đọc, phân tích, kiểm tra chất lượng dữ liệu ở bảng cuối, đã được lưu.
Các job bao gồm:
